...
* Enable TLS for agents:  set tls and add path to PEM files

```ini
[General]
# Hostname of the CM server.
server_host=ip-10-0-1-128.eu-west-1.compute.internal
...
verify_cert_file=/opt/cloudera/security/x509/ip-10-0-1-128.eu-west-1.compute.internal.pem
...
client_cert_file=/opt/cloudera/security/x509/ip-10-0-1-128.eu-west-1.compute.internal.pem
